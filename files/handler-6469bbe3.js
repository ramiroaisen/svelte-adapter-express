...
import require$$1$1, { Readable } from 'stream';
...
SendStream.prototype.redirect = function redirect (path) {
  ...
  var doc = createHtmlDocument$1('Redirecting', 'Redirecting to <a href="' + escapeHtml$1(loc) + '">' +
    escapeHtml$1(loc) + '</a>');
...
var serveStatic$1 = serveStatic$2.exports;
...
const handler = sequence(
	[
		serve(path$1.join(__dirname, '/client'), 31536000, true),
		serve(path$1.join(__dirname, '/static'), 0),
		serve(path$1.join(__dirname, '/prerendered'), 0),
		ssr
	].filter(Boolean)
);

export { escapeHtml_1 as a, setprototypeof as b, send$2 as c, depd_1 as d, encodeurl as e, etag_1 as f, fresh_1 as g, httpErrors as h, serveStatic$2 as i, handler as j, onFinished$2 as o, parseurl$1 as p, rangeParser_1 as r, statuses$1 as s };
